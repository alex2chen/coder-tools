...
public class SevenZ_unit {
    ...
    public void run() throws IOException {
        ...
        com.github.common.io.compress.SevenZ.compress(MULTIPLE_RESOURCES_PATH, resource1, resource2, resource3);
        // decompress multiple resources
        com.github.common.io.compress.SevenZ.decompress(MULTIPLE_RESOURCES_PATH, new File(OUTPUT_DIRECTORY + MULTIPLE_RESOURCES));
        // get directory file to compress
        File directory = new File(clazz.getResource("/in/dir").getFile());
        // compress recursive directory
        com.github.common.io.compress.SevenZ.compress(RECURSIVE_DIRECTORY_PATH, directory);
