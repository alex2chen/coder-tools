 ...
 */
public class ClassUtil_unit {
    @Test
    public void getMessage() {
        assertThat(ClassUtil.getShortClassName(ClassUtil_unit.class)).isEqualTo("ClassUtilTest");
        assertThat(ClassUtil.getShortClassName(BClass.class)).isEqualTo("ClassUtilTest.BClass");

        assertThat(ClassUtil.getShortClassName(ClassUtil_unit.class.getName())).isEqualTo("ClassUtilTest");
        assertThat(ClassUtil.getShortClassName(BClass.class.getName())).isEqualTo("ClassUtilTest.BClass");

        assertThat(ClassUtil.getPackageName(ClassUtil_unit.class)).isEqualTo("org.springside.modules.utils.reflect");
        assertThat(ClassUtil.getPackageName(BClass.class)).isEqualTo("org.springside.modules.utils.reflect");
        assertThat(ClassUtil.getPackageName(ClassUtil_unit.class.getName())).isEqualTo("org.springside.modules.utils.reflect");
