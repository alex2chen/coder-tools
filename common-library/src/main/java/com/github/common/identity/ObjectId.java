...
/**
 * @Author: alex
 * @Description: 全局唯一 id 生成器，是 Java 自带 UUID 性能的 200x
...
public final class ObjectId implements Serializable {
    ...
    public String toHexString() {
        ...
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 8, HexUtil.byteToHexLE(union >>> 56));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 10, HexUtil.byteToHexLE(union >>> 48));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 12, HexUtil.byteToHexLE(union >>> 40));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 14, HexUtil.byteToHexLE(union >>> 32));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 16, HexUtil.byteToHexLE(union >>> 24));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 18, HexUtil.byteToHexLE(union >>> 16));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 20, HexUtil.byteToHexLE(union >>> 8));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 22, HexUtil.byteToHexLE(union));
    ...
    public String toHexString32() {
        ...
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 8 + 8, HexUtil.byteToHexLE(union >>> 56));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 10 + 8, HexUtil.byteToHexLE(union >>> 48));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 12 + 8, HexUtil.byteToHexLE(union >>> 40));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 14 + 8, HexUtil.byteToHexLE(union >>> 32));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 16 + 8, HexUtil.byteToHexLE(union >>> 24));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 18 + 8, HexUtil.byteToHexLE(union >>> 16));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 20 + 8, HexUtil.byteToHexLE(union >>> 8));
        unsafe().putShort(bytes, ARRAY_BYTE_BASE_OFFSET + 22 + 8, HexUtil.byteToHexLE(union));
